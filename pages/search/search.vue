		...
		<view class="container">
			<scroll-view scroll-y="true">
				<view class="search-search">
					...
					<input @input="handleToSuggest" @confirm="handleToSearch(searchWord)" v-model="searchWord" type="text" placeholder="搜索歌曲" />
					<text class="iconfont icon-guanbi" @click="handleToClose" v-show="searchType!=1"></text>
				</view>
				<block v-if="searchType==1">
					...
					<view class="search-history">
						<view class="search-history-head">
							<text>历史记录</text>
							<text class="iconfont icon-lajitong" @click="handleToClear"></text>
						</view>
				...
				<block v-else-if="searchType==2">
					<view class="search-result">
						<view class="search-result-item" v-for="(item,index) in searchlist" :key="index" @click="handleToDetail(item.id)">
				...
				<block v-else-if="searchType==3">
					<view class="search-suggest">
						...
						<view @click="handleToWord(item.keyword)" class="search-suggest-item" v-for="(item,index) in searchSuggest" :key="index">
...
<style scoped lang="less">
	...
	.search-history{margin: 0rpx 30rpx 50rpx 30rpx;
	font-size: 26rpx;}
	.search-history-head{display: flex;
